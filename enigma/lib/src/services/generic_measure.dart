...
var dartData = fromJson<GenericMeasureLayout>(GenericMeasureLayout,jsonData);
return dartData;
}
...
var dartData = fromJson<GenericMeasureProperties>(GenericMeasureProperties,jsonData);
return dartData;
}
...
var dartData = fromJson<NxLibraryMeasureDef>(NxLibraryMeasureDef,jsonData);
return dartData;
}
