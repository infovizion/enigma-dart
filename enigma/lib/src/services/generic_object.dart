...
var dartData = fromJson<GenericObjectLayout>(GenericObjectLayout,jsonData);
return dartData;
}
  /// Retrieves the values of a list object.
  /// A data set is returned.
  Future<BuiltList<NxCell>> getListObjectData(String path, BuiltList<NxCell> pages) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  /// A data set is returned.
  Future<BuiltList<NxCell>> getHyperCubeData(String path, BuiltList<NxCell> pages) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getHyperCubeReducedData(String path, BuiltList<NxCell> pages, int zoomFactor, String reductionMode) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getHyperCubePivotData(String path, BuiltList<NxCell> pages) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getHyperCubeStackData(String path, BuiltList<NxCell> pages, int maxNbrCells) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getHyperCubeContinuousData(String path, NxContinuousDataOptions options, bool reverseSort) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getHyperCubeTreeData(String path, NxTreeDataOption nodeOptions) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return dartData;
  ...
  /// </tr>
  /// </table>
  Future<BuiltList<NxCell>> getHyperCubeBinnedData(String path, BuiltList<NxCell> pages, NxViewPort viewport, BuiltList<NxCell> dataRanges, int maxNbrCells, int queryLevel, int binningMethod) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qMaxNbrCells'] = maxNbrCells;
...
var dartData = fromJson<GenericObjectProperties>(GenericObjectProperties,jsonData);
return dartData;
}
  /// Returns the identifier, the type and the properties of the object.
...
var dartData = fromJson<GenericObjectEntry>(GenericObjectEntry,jsonData);
return dartData;
}
...
return dartData;
  ...
  Future<void> clearSelections(String path, BuiltList<NxCell> colIndices) async {
var params = <String, dynamic>{};
params['qPath'] = path;
var rawResult = await query('ClearSelections', params);
  ...
  Future<String> exportData(String fileType, String path, String fileName, String exportState) async {
var params = <String, dynamic>{};
...
return rawResult['result']['qUrl'];
  ...
  Future<bool> selectListObjectValues(String path, BuiltList<NxCell> values, bool toggleMode, bool softLock) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return rawResult['result']['qSuccess'];
  ...
  Future<bool> selectListObjectContinuousRange(String path, BuiltList<NxCell> ranges, bool softLock) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qSoftLock'] = softLock;
...
var rawResult = await query('AbortListObjectSearch', params);
  ...
  Future<void> acceptListObjectSearch(String path, bool toggleMode, bool softLock) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qToggleMode'] = toggleMode;
params['qSoftLock'] = softLock;
...
var rawResult = await query('Unlock', params);
  ...
  /// * The selection applies to a locked field.
  /// * A range selection is performed and the parameter _OneAndOnlyOne_ is set to true in the definition of the object.
  Future<bool> selectHyperCubeValues(String path, int dimNo, BuiltList<NxCell> values, bool toggleMode) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qDimNo'] = dimNo;
params['qToggleMode'] = toggleMode;
...
return rawResult['result']['qSuccess'];
  ...
  /// * The selection applies to a locked field.
  /// * A range selection is performed and the parameter _OneAndOnlyOne_ is set to true in the definition of the object.
  Future<bool> selectHyperCubeCells(String path, BuiltList<NxCell> rowIndices, BuiltList<NxCell> colIndices, bool softLock, bool deselectOnlyOneSelected) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qSoftLock'] = softLock;
...
return rawResult['result']['qSuccess'];
  ...
  /// * The selection applies to a locked field.
  /// * A range selection is performed and the parameter _OneAndOnlyOne_ is set to true in the definition of the object.
  Future<bool> selectPivotCells(String path, BuiltList<NxCell> selections, bool softLock, bool deselectOnlyOneSelected) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qSoftLock'] = softLock;
params['qDeselectOnlyOneSelected'] = deselectOnlyOneSelected;
...
return rawResult['result']['qSuccess'];
  ...
  /// * The selection applies to a locked field.
  /// * A range selection is performed and the parameter _OneAndOnlyOne_ is set to true in the definition of the object.
  Future<bool> rangeSelectHyperCubeValues(String path, BuiltList<NxCell> ranges, BuiltList<NxCell> columnsToSelect, bool orMode, bool deselectOnlyOneSelected) async {
var params = <String, dynamic>{};
params['qPath'] = path;
...
return rawResult['result']['qSuccess'];
  ...
  Future<bool> multiRangeSelectHyperCubeValues(String path, BuiltList<NxCell> ranges, bool orMode, bool deselectOnlyOneSelected) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qOrMode'] = orMode;
params['qDeselectOnlyOneSelected'] = deselectOnlyOneSelected;
...
return rawResult['result']['qSuccess'];
  ...
  Future<bool> multiRangeSelectTreeDataValues(String path, BuiltList<NxCell> ranges, bool orMode, bool deselectOnlyOneSelected) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qOrMode'] = orMode;
params['qDeselectOnlyOneSelected'] = deselectOnlyOneSelected;
...
return rawResult['result']['qSuccess'];
  ...
  /// The following is returned in the output:
  /// <div class=note>The operation is successful if **qSuccess** is set to true. </div>
  Future<bool> selectHyperCubeContinuousRange(String path, BuiltList<NxCell> ranges, bool softLock) async {
var params = <String, dynamic>{};
params['qPath'] = path;
params['qSoftLock'] = softLock;
...
return dartData;
  ...
  Future<NxInfo> createChild(GenericObjectProperties prop, GenericObjectProperties propForThis) async {
var params = <String, dynamic>{};
...
return dartData;
  ...
  /// 
  /// <div class=note>The operation is successful if **qSuccess** is set to true. </div>
  Future<bool> destroyChild(String id, GenericObjectProperties propForThis) async {
var params = <String, dynamic>{};
params['qId'] = id;
