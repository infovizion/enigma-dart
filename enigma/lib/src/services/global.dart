...
var dartData = fromJson<ProgressData>(ProgressData,jsonData);
return dartData;
}
...
var dartData = fromJson<InteractDef>(InteractDef,jsonData);
return dartData;
}
...
return rawResult['result']['qReturn'];
  ...
  Future<String> createDocEx(String docName, String userName, String password, String serial, String localizedScriptMainSection) async {
var params = <String, dynamic>{};
...
return rawResult['result']['qReturn'];
  ...
  /// </tr>
  /// </table>
  Future<bool> createApp(String appName, String localizedScriptMainSection) async {
var params = <String, dynamic>{};
...
var rawResult = await query('ReloadExtensionList', params);
  ...
  /// 
  /// <div class=note>The operation is successful if **qSuccess** is set to true. </div>
  Future<bool> replaceAppFromID(String targetAppId, String srcAppID, BuiltList<NxCell> ids) async {
var params = <String, dynamic>{};
...
return rawResult['result']['qSuccess'];
  ...
  Future<bool> copyApp(String targetAppId, String srcAppId, BuiltList<NxCell> ids) async {
var params = <String, dynamic>{};
params['qTargetAppId'] = targetAppId;
params['qSrcAppId'] = srcAppId;
...
return rawResult['result']['qSuccess'];
  ...
  Future<bool> exportApp(String targetPath, String srcAppId, BuiltList<NxCell> ids, bool noData) async {
var params = <String, dynamic>{};
...
return rawResult['result']['qUniqueID'];
  ...
  Future<ObjectInterface> openDoc(String docName, String userName, String password, String serial, bool noData) async {
var params = <String, dynamic>{};
params['qDocName'] = docName;
params['qUserName'] = userName;
params['qPassword'] = password;
...
var dartData = fromJson<AppEntry>(AppEntry,jsonData);
return dartData;
}
  ...
  Future<void> configureReload(bool cancelOnScriptError, bool useErrorData, bool interactOnError) async {
var params = <String, dynamic>{};
...
return dartData;
  ...
  Future<BuiltList<NxCell>> getDatabasesFromConnectionString(Connection connection) async {
var params = <String, dynamic>{};
...
var dartData = fromJson<NxEngineVersion>(NxEngineVersion,jsonData);
return dartData;
}
